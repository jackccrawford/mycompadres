...
import { tosContent } from '../../data/homeText';
...
export const TosModal: React.FC<TosModalProps> = ({ visible, onClose }) => {
        ...
        <View style={styles.centeredView}>
          <View style={[styles.modalView, { backgroundColor: theme.colors.background }]}>  
            <View style={[styles.modalHeader, { borderBottomColor: theme.colors.outline }]}>  
              <Text style={[styles.modalTitle, { color: theme.colors.onSurface }]}>Terms of Service</Text>
            ...
            <ScrollView style={styles.modalScrollView} contentContainerStyle={styles.modalScrollViewContent}>
              <Text style={[styles.modalText, { color: theme.colors.onSurface }]}>{tosContent}</Text>
            </ScrollView>
          </View>
        </View>
      </SafeAreaView>
